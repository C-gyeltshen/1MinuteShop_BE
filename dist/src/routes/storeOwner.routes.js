...
import { createStoreOwnerSchema, loginSchema, } from "../validators/storeOwner.valadator.js";
...
storeOwnerRoutes.post("/register", validate(createStoreOwnerSchema), (c) => controller.register(c));
// POST /api/store-owners/login
storeOwnerRoutes.post("/login", validate(loginSchema), (c) => controller.login(c));
...
storeOwnerRoutes.post("/logout", authMiddleware, (c) => controller.logout(c));
